...
/* harmony import */ var _modules_mt_notes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/mt-notes */ "./src/modules/mt-notes.js");
...
const notes = new _modules_mt_notes__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
class Search {
  constructor() {
    ...
    //$("#search-term");
    this.events();
    this.resultDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".result");
  }
  events() {
  ...
  senddata() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(local_url.url + '/wp-json/wp/v2/posts?search=' + this.search_field, function (posts) {
      this.resultDiv.html(`
...
class Notes {
  constructor() {
    this.edit = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".edit-note");
    this.Events();
  }
  Events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".delete-note").on("click", this.DeleteFunctions);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".up-note").on("click", this.SaveFunction);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".submit-note").on("click", this.createFunction);
  }
  createFunction(e) {
    var newPost = {
      'title': jquery__WEBPACK_IMPORTED_MODULE_0___default()('.new-note-title').val(),
      'content': jquery__WEBPACK_IMPORTED_MODULE_0___default()('.note-note-body').val(),
      'status': 'publish'
    };
  ...
  SaveFunction(e) {
    var id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li");
    var idd = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li").attr("data-id");
    var outputData = {
  ...
  DeleteFunctions(e) {
    var id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li").attr("data-id");
    var idd = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li").attr("data-id");
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      beforeSend: xhr => {
        xhr.setRequestHeader('X-WP-Nonce', local_url.nonce);
