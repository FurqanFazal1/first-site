    ...
    <div class="full-width-split group">
      ...
      <div class="full-width-split__two">
        <div class="full-width-split__inner">
          ...
          <?php
            $selectedPost = new WP_Query(array(
              'posts_per_page' => 2
            ));


              while($selectedPost->have_posts()){
                $selectedPost->the_post(  );
          ...
          <div class="event-summary">
            ...
            <div class="event-summary__content">
              ...
              <p><?php echo wp_trim_words( get_the_content(), 15);?> <a href="<?php echo the_permalink();?>" class="nu gray">Read more</a></p>
            </div>
          </div>
